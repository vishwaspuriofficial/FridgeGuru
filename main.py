...
page = Markdown(
    """
  <div style="font-family: 'Lato', sans-serif; color: #064F3C; margin: 0; padding: 0; box-sizing: border-box;">
    ...
    <div class="special" style="display: grid; align-items: center; grid-template-columns: 2fr 2fr; gap: 5px;">
        <div>
            ...
            <p id="description" class="text" style="flex-grow: 1;">Have no idea what to make with the contents left in your fridge? FridgeGuru provides easy and delicious recipes tailored to your preferences based on only what you have at home! Simply take one picture of your entire fridge showing all its contents, and get recipe recommendations in an instant. 🙀</p>
        </div>
